...
class Item extends Model
{
    ...
    protected $fillable = [
        'clinic_id', 'name', 'code', 'generic_name', 'brand_name', 'category', 'item_type_id', 'consultation_type_id', 'unit_of_measure_id', 'lens_type_id',
        'is_consultation_item', 'is_stock_item', 'balance', 'new_balance', 'unit_buying_price', 'selling_price', 'templates', 'status',
