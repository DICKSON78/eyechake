                  ...
                  <Grid container spacing={2}>
                    <Grid size={{ xs: 6 }}>
                      <Box 
                        ...
                        onClick={() => navigate('/inventory-management/stocktaking')}
                      >
                        <StocktakingIcon sx={{ fontSize: 28.8, color: '#9C27B0', mb: 1 }} />
                        <Typography variant="subtitle2">Stock Taking</Typography>
                      </Box>
                    </Grid>
                    <Grid size={{ xs: 6 }}>
                      <Box 
                    ...
                    <Grid size={{ xs: 6 }}>
                      <Box 
                        ...
                        onClick={() => navigate('/inventory-management/lens-tracking')}
                      >
                        <LensIcon sx={{ fontSize: 28.8, color: '#2196F3', mb: 1 }} />
                        <Typography variant="subtitle2">Lens Tracking</Typography>
                      </Box>
                    </Grid>
                    <Grid size={{ xs: 6 }}>
                      <Box 
                        ...
                        onClick={() => navigate('/inventory-management/reports')}
                      >
                        <ChartIcon sx={{ fontSize: 28.8, color: '#4CAF50', mb: 1 }} />
