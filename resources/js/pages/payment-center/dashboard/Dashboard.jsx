                  ...
                  <CardContent sx={{ flex: 1, px: { xs: 2, sm: 3 }, pb: { xs: 2, sm: 3 }, pt: { xs: 2, sm: 3 } }}>
                    <ChartWrapper
                      options={{
                        ...
                        xaxis: {
                        categories: (Array.isArray(data?.statistics?.payment_trends) && data.statistics.payment_trends.length > 0
                          ? data.statistics.payment_trends
                          : [
                              { date: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], revenue: 0 },
                              { date: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], revenue: 0 },
                              { date: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], revenue: 0 },
                              { date: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], revenue: 0 },
                              { date: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], revenue: 0 },
                              { date: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], revenue: 0 },
                              { date: new Date().toISOString().split('T')[0], revenue: 0 }
                            ]
                        ).map((e) => {
                          if (!e) return '';
                          try {
                            const date = new Date(e?.date || e);
                      ...
                      series={[
                        {
                          name: "Revenue",
                          data: (Array.isArray(data?.statistics?.payment_trends) && data.statistics.payment_trends.length > 0
                            ? data.statistics.payment_trends
                            : [
                                { date: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], revenue: 0 },
                                { date: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], revenue: 0 },
