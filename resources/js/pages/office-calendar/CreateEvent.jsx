...
const CreateEvent = ({ initialDate, modal, fetchEvents }) => {
  ...
  const [reminderMode, setReminderMode] = useState("none"); // "none", "preset", "custom"

  const { data, loading, error, handlePost } = usePost("api/office-calendar", {
    ...formData,
  ...
  }, [data, fetchEvents, modal, addToast]);
