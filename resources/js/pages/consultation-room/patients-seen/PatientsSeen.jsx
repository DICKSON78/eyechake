...
const PatientsSeen = () => {
  ...
  useEffect(() => {
    document.title = `Patients Seen - ${window.APP_NAME}`;
  }, []);
                ...
                renderCell: (item) => (
                  ...
                  >
                    <Button
                      ...
                      onClick={() =>
                        navigate(
                          `/consultation-room/consultation-patients/consulted/${item.payment_cache_item.payment_cache.check_in.patient_id}/${item.id}/clinical-notes`
                        )
                      }
                    >
                      View
